...
lang_callbacks = ('sq', 'af', 'ar', 'az', 'eu', 'be', 'bg', 'ca', 'zh_cn', 'zn_tw', 'hr', 'cz', 'da', 'nl', 'en', 'fi',
                  'fr', 'gl', 'de', 'el', 'he', 'hi', 'hu', 'is', 'id', 'it', 'ja', 'kr', 'ku', 'la', 'lt', 'mk', 'no',
                  'fa', 'pl', 'pt', 'pt_bz', 'ro', 'ru', 'sr', 'sk', 'sl', 'es', 'se', 'th', 'tr', 'ua', 'vi', 'zu')
...
lang_kb_buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🇨🇳 (simplified)", callback_data='zh_cn'),
        InlineKeyboardButton(text="🇨🇳 (Traditional)", callback_data='zn_tw')
    ],
    [
    ...
    [InlineKeyboardButton(text='Принять', callback_data='menu')]
]
